...
def admin_dashboard(request):
    ...
    daily_tickets = (
        Ticket.objects.filter(created_at__date__gte=last_30_days)
...
def export_tickets_csv(request):
    ...
    response.write("\ufeff".encode("utf8"))  # BOM for Excel reading Thai correctly
...
def ticket_edit(request, ticket_id):
    ...
    return render(
        request,
        "analytics/ticket_form.html",
        {"ticket": ticket, "categories": categories, "technicians": technicians},
    )
